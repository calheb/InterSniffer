...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"f0ddbfe3-5afa-4957-bdd2-5ba91a68430d\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [27 x i8] c"com.companyname.lolsniffer\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 596, ; number_of_dso_cache_entries
	i32 33555256, ; android_runtime_jnienv_class_token
	i32 100672044, ; jnienv_initialize_method_token
	i32 100672043, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.16 = internal constant [46 x i8] c"libaot-System.Text.Encoding.Extensions.dll.so\00", align 16
@__DSOCacheEntry_name.17 = internal constant [43 x i8] c"libaot-System.Reflection.Primitives.dll.so\00", align 16
...
@__DSOCacheEntry_name.38 = internal constant [50 x i8] c"libaot-System.Reflection.Emit.ILGeneration.dll.so\00", align 16
...
@__DSOCacheEntry_name.44 = internal constant [40 x i8] c"libaot-System.Drawing.Primitives.dll.so\00", align 16
...
@__DSOCacheEntry_name.48 = internal constant [33 x i8] c"libaot-System.Data.Common.dll.so\00", align 16
@__DSOCacheEntry_name.49 = internal constant [25 x i8] c"libaot-LolSniffer.dll.so\00", align 16
...
@__DSOCacheEntry_name.71 = internal constant [49 x i8] c"libaot-System.Reflection.Emit.Lightweight.dll.so\00", align 16
...
@__DSOCacheEntry_name.75 = internal constant [30 x i8] c"libaot-System.IO.Pipes.dll.so\00", align 16
...
@__DSOCacheEntry_name.79 = internal constant [29 x i8] c"libaot-System.Drawing.dll.so\00", align 16
@__DSOCacheEntry_name.80 = internal constant [45 x i8] c"libaot-System.Runtime.InteropServices.dll.so\00", align 16
@__DSOCacheEntry_name.81 = internal constant [40 x i8] c"libaot-Xamarin.AndroidX.Activity.dll.so\00", align 16
@__DSOCacheEntry_name.82 = internal constant [38 x i8] c"libaot-Xamarin.AndroidX.Window.dll.so\00", align 16
@__DSOCacheEntry_name.83 = internal constant [20 x i8] c"libSystem.Native.so\00", align 16
@__DSOCacheEntry_name.84 = internal constant [34 x i8] c"libaot-System.Formats.Asn1.dll.so\00", align 16
...
@__DSOCacheEntry_name.94 = internal constant [31 x i8] c"libaot-System.Text.Json.dll.so\00", align 16
@__DSOCacheEntry_name.95 = internal constant [19 x i8] c"libmonosgen-2.0.so\00", align 16
@__DSOCacheEntry_name.96 = internal constant [33 x i8] c"libaot-System.Private.Xml.dll.so\00", align 16
@__DSOCacheEntry_name.97 = internal constant [45 x i8] c"libaot-Xamarin.AndroidX.Navigation.UI.dll.so\00", align 16
@__DSOCacheEntry_name.98 = internal constant [33 x i8] c"libaot-System.Private.Uri.dll.so\00", align 16
@__DSOCacheEntry_name.99 = internal constant [40 x i8] c"libaot-Xamarin.AndroidX.Fragment.dll.so\00", align 16
@__DSOCacheEntry_name.100 = internal constant [43 x i8] c"libaot-Microsoft.Extensions.Logging.dll.so\00", align 16
@__DSOCacheEntry_name.101 = internal constant [56 x i8] c"libaot-Microsoft.Extensions.Logging.Abstractions.dll.so\00", align 16

; dso_cache
@dso_cache = local_unnamed_addr global [596 x %struct.DSOCacheEntry] [
	; 0
	...
	; 53
	%struct.DSOCacheEntry {
		i64 2029067379285842378, ; hash 0x1c28b207efaa59ca, from name: aot-LolSniffer.dll.so
		i8 0, ; ignore
	...
	; 170
	%struct.DSOCacheEntry {
		i64 6064827411730333647, ; hash 0x542a9865ec3cffcf, from name: LolSniffer
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.49, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 202
	%struct.DSOCacheEntry {
		i64 7195839515650788145, ; hash 0x63dcc1ea0f158b31, from name: aot-LolSniffer
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.49, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 236
	%struct.DSOCacheEntry {
		i64 7925547786074843372, ; hash 0x6dfd33b8575fe8ec, from name: libaot-LolSniffer
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.49, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([56 x i8], [56 x i8]* @__DSOCacheEntry_name.101, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 346
	%struct.DSOCacheEntry {
	...
	; 414
	%struct.DSOCacheEntry {
		i64 12855291473209475019, ; hash 0xb2672b7c10c23fcb, from name: LolSniffer.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.49, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 552
	%struct.DSOCacheEntry {
		i64 17165292996796803077, ; hash 0xee375f08f392e805, from name: libaot-LolSniffer.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.49, i32 0, i32 0), ; name
		i8* null; handle
	}, 
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [96 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 16
